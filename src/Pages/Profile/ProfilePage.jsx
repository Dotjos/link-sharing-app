...
function ProfilePage() {
  ...
  return <div className="bg-white w-full text-Nickel  text-sm rounded-lg p-4 lg:w-7/12">
    ...
    <form className="bg-whiteFA grid p-3 w-full rounded-lg">
      <Input required={true} type="text" label="Firstname" asteriks={true} id="Firstname" placeholder="e.g.John"/>
      <Input required={true} type="text" label="Lastname" asteriks={true} id="Lastname" placeholder="e.g.Appleseed"/>
      <Input required={false}  type="mail" label="Email" asteriks={false} id="Email" placeholder="e.g.email@example.com"/>
    </form>
